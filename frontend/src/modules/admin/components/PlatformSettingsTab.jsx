        ...
        <div className="animate-fade-in flex flex-col gap-8">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'rgba(24, 0, 173,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Settings size={24} style={{ color: 'var(--primary)' }} /></div>
            ...
            <div className="glass-card" style={{ padding: '2rem' }}>
                ...
                <div style={{ marginBottom: '1.5rem', padding: '1rem', background: 'rgba(24, 0, 173,0.05)', borderRadius: '10px', border: '1px solid rgba(24, 0, 173,0.2)' }}>
                ...
                <div style={{ marginTop: '1.5rem', padding: '1rem', background: 'rgba(245,158,11,0.05)', borderRadius: '10px', border: '1px solid rgba(245,158,11,0.2)' }}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                        <span style={{ color: '#d97706', fontWeight: 700, fontSize: '1rem', lineHeight: 1, marginTop: '2px' }}>??</span>
                        <div style={{ flex: 1 }}>
